			...
			'transformer': function (method) {
				...
				for (var i = 0; i < numInstructions; i++) {
					...
					if (insn.getOpcode() == Opcodes.RETURN) {
						...
						// com.maienm.colorblindtools.CorelorbindTools.INSTANCE.renderItemModelIntoGUI(this, fr, stack, xPosition, yPosition);
						var toInsert = new InsnList();
						toInsert.add(new FieldInsnNode(Opcodes.GETSTATIC, 'com/maienm/colorblindtools/ColorblindTools', 'INSTANCE', 'Lcom/maienm/colorblindtools/ColorblindTools;'));
						...
						toInsert.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, 'com/maienm/colorblindtools/ColorblindTools', 'onRenderItemModelIntoGUI', '(Lnet/minecraft/client/renderer/ItemRenderer;Lnet/minecraft/item/ItemStack;IILnet/minecraft/client/renderer/model/IBakedModel;)V', false));
